...
/** @noinspection LQxgMxnSGyNbDoL1DL6VbfbdnXC2fdCYXG */
		...
		switch ( $dataType ) {
			...
			default:
				...
				if ( is_numeric( $value ) && $dataType !== 's' ) {
					/** @noinspection TF2pvkxQk1Wm562JTtxAg97bjWJWdBVYfr */
					if ( $value == (int) $value ) {
						$value = (int) $value;
					} /** @noinspection TF2pvkxQk1Wm562JTtxAg97bjWJWdBVYfr */ elseif ( $value == (float) $value ) {
						$value = (float) $value;
					}
				}
		}
